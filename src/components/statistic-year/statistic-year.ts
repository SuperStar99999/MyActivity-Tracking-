...
/*
  Generated class for the StatisticYear component.

  See https://angular.io/docs/ts/latest/api/core/index/ComponentMetadata-class.html
  for more info on Angular 2 Components.
*/
@Component({
  selector: 'statistic-year',
  templateUrl: 'statistic-year.html'
})
export class StatisticYearComponent {
  ...
  getValues() {
    this.activitise.getYear(this.users.uid).subscribe(activities => {
